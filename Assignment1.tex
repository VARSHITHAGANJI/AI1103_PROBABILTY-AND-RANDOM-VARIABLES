...
\begin{enumerate}
   \item \pr{A|B} = $\frac{P\brak{B}}{P\brak{A}}$
   \item  \pr{A|B} $< P\brak{A}$ 
   \item \pr{A|B} $\geq P\brak{A}$ 
   \item None of these
\end{enumerate}
\section*{Solution}
...
\end{align}  
\textnormal{By multiplying with \pr{A} on both sides of the inequality, we get}
\begin{align}
 \frac{\pr{A}}{\pr{B}}\geq {\normalsize{\pr{A}}}
\end{align}
